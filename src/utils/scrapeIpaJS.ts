...
// Injects JavaScript to find all IPA elements within the English section
const _scrapeIpaLogic = `
  const ipaElements = Array.from(document.querySelectorAll('div:has(#English) + section .IPA'));
